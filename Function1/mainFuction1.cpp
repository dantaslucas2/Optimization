...
vector<double> dfp_method(const vector<double>& x0, int max_iter=max_iterations, double tol=1e-4) {
    vector<double> x = x0;
    vector<vector<double>> H_inv(5, vector<double>(5, 0.0)); // Matriz Hessiana inversa aproximada
    for (int i = 0; i < 5; ++i) {
        H_inv[i][i] = 1.0;
    }
...
int main() {
    int awaitInput;
    vector<double> x0 = {0, 0.2, 0, 0.3, 0};
    cout << endl<< endl<< endl;
    vector<double> x_grad = dfp_method(x0);
    cout << endl<< endl<< endl;

    vector<double> x1 = {0.1, 0, 0.3, 0, 0};
    cout << endl<< endl<< endl;
    vector<double> x_grad1 = dfp_method(x1);
    cout << endl<< endl<< endl;

    vector<double> x2 = {0, 0, -0.4, 0, -0.1};
    cout << endl<< endl<< endl;
    vector<double> x_grad2 = dfp_method(x2);
    cout << endl<< endl<< endl;

    vector<double> x3 = {0, -0.2, 0, 0.2, 0.3};
    cout << endl<< endl<< endl;
